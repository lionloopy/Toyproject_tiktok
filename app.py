...
def web_signup_post():
    ...
    doc = {'name': name_receive, 'email': email_receive, 'password': password_hash}
...
for music in a:
    ...
    if music is not None:
        doc = {'image': b['src'], 'rank': rank, 'title': title, 'singer': singer, 'album': album}
...
def posting_get():
    ...
    return jsonify({'musics': music_list, 'comments':comment_list})
